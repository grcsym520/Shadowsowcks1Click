...
install_ssr(){
	...
	echo 'libsodium安装完成'
  	git clone -b master https://github.com/grcsym520/Shadowsowcks1Click.git && mv Shadowsowcks1Click shadowsocksr && cd shadowsocksr && chmod +x setup_cymysql.sh && chmod +x ./initcfg.sh && ./setup_cymysql.sh && ./initcfg.sh
